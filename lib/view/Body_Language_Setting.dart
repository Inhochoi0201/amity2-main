              ...
              children: [
                 Column(
                      ...
                      children: [
                        ...
                        controller.moreTeamSetting() : controller.morePlayerSetting(),
                        ),
                        ...
                        GestureDetector(
                          onTap: () {
                            if(!controller.isTeam.value){
                              if(controller.selectedTheme.value == '테마를 선택해주세요.'|| controller.selectedMinuteTimer.value == '0' || controller.selectedMorePlayer.value == '0' ){
